...
const MergedReviewsMetaTest4 = require('../Database/Schema/MergedReviewsMetaTest4.js');
...
app.get('/reviews/meta', (req, res) => {
  console.log("meta query:", req.query)
//mergedreviewsmetatest4s
  MergedReviewsMetaTest4.find({}).limit(5)
  .then(response => {
